...
import 'package:flutter/cupertino.dart'
    hide CupertinoPicker, CupertinoDatePicker;
...
class _CupertinoPickerState extends State<CupertinoPicker> {
  ...
  Widget _buildMagnifierScreen() {
    ...
    return IgnorePointer(
      child: Center(
        child: Container(
          decoration: BoxDecoration(color: AppColors.cFFFFFF), // todo тут поменял
  ...
  Widget build(BuildContext context) {
    ...
    final Widget result = DefaultTextStyle(
      ...
      child: Stack(
        children: <Widget>[
          _buildMagnifierScreen(), // todo переместил наверх в стеке
          Positioned.fill(
