...
import 'package:emma_mobile/chart/mp/core/cache.dart';
...
//      _cubicFillPath.reset();
    ...
    canvas.drawPath(_cubicPath, renderPaint); //TODO
  }
...
//    } else {
    ...
    if (dataSet.isGradientEnabled()) {
      drawFilledPath3(c, spline, dataSet.getGradientColor1().startColor,
  ...
  void drawLinearFill(
    ...
    do {
      ...
      if (currentStartIndex <= currentEndIndex) {
        ...
        if (dataSet.isGradientEnabled()) {
          drawFilledPath3(c, filled, dataSet.getGradientColor1().startColor,
              dataSet.getGradientColor1().endColor);
        } else {
          drawFilledPath2(
  ...
  void drawValues(Canvas c) {
    if (isDrawingValuesAllowed(_provider)) {
      ...
      for (int i = 0; i < dataSets.length; i++) {
        ...
        if (!dataSet.getIsDrawCirclesEnabled()) valOffset = valOffset ~/ 2;
  ...
  void drawCircles(Canvas c) {
    ...
    for (int i = 0; i < dataSets.length; i++) {
      ...
      if (!dataSet.isVisible() ||
          !dataSet.getIsDrawCirclesEnabled() ||
