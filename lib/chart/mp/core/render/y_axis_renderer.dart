...
import 'package:emma_mobile/chart/mp/core/enums/limit_label_postion.dart';
import 'package:emma_mobile/chart/mp/core/enums/y_axis_label_position.dart';
import 'package:emma_mobile/chart/mp/core/limit_line.dart';
import 'package:emma_mobile/chart/mp/core/poolable/point.dart';
import 'package:emma_mobile/chart/mp/core/render/axis_renderer.dart';
      ...
      if (axisDependency == AxisDependency.LEFT) {
        if (position == YAxisLabelPosition.OUTSIDE_CHART) {
          axisLabelPaint.paint(
              c,
              Offset(fixedPosition - axisLabelPaint.width - 10.w,
                  positions[i * 2 + 1] - axisLabelPaint.height / 1.25));
        } else {
          axisLabelPaint.paint(
              c,
