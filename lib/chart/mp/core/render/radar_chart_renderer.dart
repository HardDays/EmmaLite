...
import 'package:emma_mobile/chart/mp/core/data/radar_data.dart';
import 'package:emma_mobile/chart/mp/core/data_interfaces/i_radar_data_set.dart';
import 'package:emma_mobile/chart/mp/core/entry/radar_entry.dart';
...
import 'package:emma_mobile/chart/mp/core/render/line_radar_renderer.dart';
...
import 'package:emma_mobile/chart/mp/painter/radar_chart_painter.dart';
...
//      } else {
      ...
      if (dataSet.isGradientEnabled()) {
        drawFilledPath3(
            c,
            surface,
            dataSet.getGradientColor1().startColor,
            dataSet.getGradientColor1().endColor);
      } else {
        drawFilledPath2(
